<?php include 'header.php'; ?>
    ...
    <form class="form-horizontal" action="." method="post">
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="ID" id="ID" value="<?php echo $watch->getId(); ?>" class="form-control" disabled>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-2" for="brand">Watch Brand</label>
            <div class="col-md-4">
                <input type="text" name="brand" id="brand" value="<?php echo $watch->getBrand(); ?>" class="form-control" autofocus>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-2" for="model">Model</label>
            <div class="col-md-4">
                <input type="text" name="model" id="model" value="<?php echo $watch->getModel(); ?>" class="form-control">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-2" for="release-year">Release Year</label>
            <div class="col-md-4">
                <input type="text" name="release-year" id="release-year" value="<?php echo $watch->getReleaseYear(); ?>" class="form-control">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-2" for="price">Price</label>
            <div class="col-md-4">
                <input type="text" name="price" id="price" value="<?php echo $watch->getPrice(); ?>" class="form-control">
            </div>
        </div>
        <div class="form-group">
