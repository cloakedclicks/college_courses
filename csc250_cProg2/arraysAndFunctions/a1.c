...
int arrayMinPos(int theArr[], int numArray, int posMin)
{
	int i = 0;
	int min = 0;
	min = theArr[0];
...
int arrayMaxPos(int theArr[], int numArray, int posMax)
{
	int i = 0;
	int max = 0;
	max = theArr[0];
...
int main()
{
    ...
    posMin = arrayPosMin(theArr, numArray, posMin);
	posMax = arrayPosMax(theArr, numArray, posMax);
